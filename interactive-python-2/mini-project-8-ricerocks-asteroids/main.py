...
# An online version could be found here: http://www.codeskulptor.org/#user43_8jiwbptVjT_0.py
...
def draw(canvas):
    ...
    # detect collisions with the ship
...
def rock_spawner():
    ...
    level_difficulty += score * .01
    rock_pos = [random.randrange(0, WIDTH), random.randrange(0, HEIGHT)]
    rock_vel = [random.random() * level_difficulty - .3, random.random() * level_difficulty - .3]
